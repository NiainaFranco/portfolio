...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="w-full flex justify-center">
      <div className="lg:max-w-[var(--max-width)] w-[var(--max-width)] w-full p-3 lg:p-7">
        <SectionSeparator>{tnavigation("pricing")}</SectionSeparator>
        <div className="lg:flex-row md:flex-row sm:flex-row flex flex-col justify-center gap-3 pt-7">
